...
// 3. Cree una función bmwSum que devuelva la suma de todos los precios de los automóviles BMW.

const bmwSum = function () {
    const marca = cars.filter(car => car.brand == 'BMW');
    const sumaPrecios = marca.reduce((add, car) => add + car.price, 0);
    console.log(sumaPrecios);
}
console.log('Suma de todos los precios de los automóviles BMW:');
bmwSum();